...
not its volume, yielding $O\!\left(\mathrm{SurfaceArea}(m_1,\dots,m_r)\cdot\log(\mathrm{Depth})\right)$
rather than $O\!\left(\mathrm{Volume}\cdot\log(\mathrm{Depth})\right)$,
