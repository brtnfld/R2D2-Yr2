...
\begin{description}[nosep]
  ...
  \item[T6: Security stripping and algorithm downgrade.]
    ...
    substituting \texttt{sha1} for \texttt{blake3}).  Unlike T1--T3, no
    signature forgery is required; the attack exploits verifier leniency
    toward missing or downgraded metadata.
...
\begin{enumerate}[label=\textbf{RQ\arabic*}]
  ...
  \item \textbf{(Adversarial soundness.)}~Can a directed adversary with
    ...
    threat model (T1--T8)? This is evaluated via the red-team study
