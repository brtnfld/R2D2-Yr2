...
all listed codes are linear over $\mathrm{GF}(2)$ and can be inverted in
closed form by an adversary: given a desired alteration, the attacker computes
a matching tail correction that preserves the checksum. They therefore detect
