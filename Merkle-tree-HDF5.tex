...
\begin{description}[nosep]
  \item[ClawHDF5 maturity.] ClawHDF5 is a relatively new project (2~stars,
    ...
    \texttt{clawhdf5-format}'s low-level parser, bypassing the high-level
    API. To avoid sinking effort into an unusable platform, we establish a
    \textbf{go/no-go decision point at the end of Month~1}: ClawHDF5 must
